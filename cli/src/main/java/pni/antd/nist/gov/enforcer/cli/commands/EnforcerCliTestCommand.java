 ...
 */
package pni.antd.nist.gov.enforcer.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import pni.antd.nist.gov.enforcer.cli.api.EnforcerCliCommands;
...
public class EnforcerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(EnforcerCliTestCommand.class);
    protected final EnforcerCliCommands service;

    public EnforcerCliTestCommand(final EnforcerCliCommands service) {
